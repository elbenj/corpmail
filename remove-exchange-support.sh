...
if [[ ! -d src/com.elbenj.email/ ]] ; then
...
rm -fr src/com.elbenj.exchange/ \
       tests/src/com.elbenj.exchange/
...
# Step 3. Remove all imports from com.elbenj.exchange (and its subpackages).
