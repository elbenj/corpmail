...
import com.elbenj.exchange.provider.GalResult.GalData;
...
public class ExchangeProvider extends ContentProvider {
    public static final String EXCHANGE_AUTHORITY = "com.elbenj.exchange.provider";
    ...
    public static final String EXTRAS_TOTAL_RESULTS = "com.elbenj.exchange.provider.TOTAL_RESULTS";
