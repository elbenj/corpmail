...
import com.elbenj.email.SecurityPolicy;
...
import com.elbenj.email.mail.MeetingInfo;
import com.elbenj.email.mail.MessagingException;
import com.elbenj.email.mail.PackedString;
...
import com.elbenj.email.service.EmailServiceConstants;
import com.elbenj.email.service.EmailServiceProxy;
import com.elbenj.email.service.EmailServiceStatus;
import com.elbenj.exchange.adapter.AbstractSyncAdapter;
import com.elbenj.exchange.adapter.AccountSyncAdapter;
import com.elbenj.exchange.adapter.CalendarSyncAdapter;
import com.elbenj.exchange.adapter.ContactsSyncAdapter;
import com.elbenj.exchange.adapter.EmailSyncAdapter;
import com.elbenj.exchange.adapter.FolderSyncParser;
import com.elbenj.exchange.adapter.GalParser;
import com.elbenj.exchange.adapter.MeetingResponseParser;
import com.elbenj.exchange.adapter.PingParser;
import com.elbenj.exchange.adapter.ProvisionParser;
import com.elbenj.exchange.adapter.Serializer;
import com.elbenj.exchange.adapter.Tags;
import com.elbenj.exchange.adapter.Parser.EasParserException;
import com.elbenj.exchange.provider.GalResult;
...
public class EasSyncService extends AbstractSyncService {
    ...
    private String getEmailFilter() {
        ...
        switch (mAccount.mSyncLookback) {
            case com.elbenj.email.Account.SYNC_WINDOW_1_DAY: {
                filter = Eas.FILTER_1_DAY;
                break;
            }
            case com.elbenj.email.Account.SYNC_WINDOW_3_DAYS: {
                filter = Eas.FILTER_3_DAYS;
                break;
            }
            case com.elbenj.email.Account.SYNC_WINDOW_1_WEEK: {
                filter = Eas.FILTER_1_WEEK;
                break;
            }
            case com.elbenj.email.Account.SYNC_WINDOW_2_WEEKS: {
                filter = Eas.FILTER_2_WEEKS;
                break;
            }
            case com.elbenj.email.Account.SYNC_WINDOW_1_MONTH: {
                filter = Eas.FILTER_1_MONTH;
                break;
            }
            case com.elbenj.email.Account.SYNC_WINDOW_ALL: {
