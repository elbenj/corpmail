...
import com.elbenj.email.activity.Debug;
import com.elbenj.email.activity.MessageList;
import com.elbenj.email.activity.setup.AccountSettingsUtils.Provider;
...
public class AccountSetupBasics extends Activity
    ...
    private final static String EXTRA_ACCOUNT = "com.elbenj.email.AccountSetupBasics.account";
    public final static String EXTRA_EAS_FLOW = "com.elbenj.email.extra.eas_flow";

    // Action asking us to return to our original caller (i.e. finish)
    private static final String ACTION_RETURN_TO_CALLER =
        "com.elbenj.email.AccountSetupBasics.return";
    ...
    private static final String ACTION_START_AT_MESSAGE_LIST =
        "com.elbenj.email.AccountSetupBasics.messageList";

    private final static String EXTRA_USERNAME = "com.elbenj.email.AccountSetupBasics.username";
    private final static String EXTRA_PASSWORD = "com.elbenj.email.AccountSetupBasics.password";

    private final static int DIALOG_NOTE = 1;
    private final static int DIALOG_DUPLICATE_ACCOUNT = 2;

    private final static String STATE_KEY_PROVIDER =
        "com.elbenj.email.AccountSetupBasics.provider";
