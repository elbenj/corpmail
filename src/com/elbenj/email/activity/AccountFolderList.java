...
import com.elbenj.email.activity.setup.AccountSettings;
import com.elbenj.email.activity.setup.AccountSetupBasics;
...
public class AccountFolderList extends ListActivity implements OnItemClickListener {
    ...
    private static final String ICICLE_SELECTED_ACCOUNT = "com.elbenj.email.selectedAccount";
