...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.elbenj.email.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.elbenj.email.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.elbenj.email.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_NOTIFY_MAIL =
        "com.elbenj.email.intent.action.MAIL_SERVICE_NOTIFY";

    private static final String EXTRA_CHECK_ACCOUNT = "com.elbenj.email.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.elbenj.email.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.elbenj.email.intent.extra.WATCHDOG";
    private static final String EXTRA_MAILBOX_ID = "com.elbenj.email.intent.extra.MAILBOX_ID";
